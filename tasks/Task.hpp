...
#ifndef MARKER_BASED_SLAM_TASK_TASK_HPP
#define MARKER_BASED_SLAM_TASK_TASK_HPP

#include "marker_based_slam/TaskBase.hpp"
#include <marker_based_slam/MarkerBasedSlam.hpp>
...
namespace marker_based_slam {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','marker_based_slam::Task')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Task(std::string const& name = "marker_based_slam::Task");
